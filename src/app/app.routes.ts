...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'assetsRightPanel', component: RightPanelPortfolioComponent, outlet: 'right-panel' },
      { path: 'erc20trade', component: Erc20TradeComponent },
      { path: 'erc20tradeRightPanel', component: RightPanelErc20TradeComponent, outlet: 'right-panel' },
      { path: 'optionstrade', component: OptionsTradeComponent },
      { path: 'optionstradeRightPanel', component: RightPanelOptionsComponent, outlet: 'right-panel' },
      { path: 'nftspottrade', component: NftSpotTradeComponent },
      { path: 'nftspottradeRightPanel', component: RightPanelNftSpotComponent, outlet: 'right-panel' },
      { path: 'binaryoptionstrade', component: BinaryOptionsTradeComponent },
      { path: 'binaryoptionstradeRightPanel', component: RightPanelBinaryOptionsComponent, outlet: 'right-panel' },
      { path: 'marginoptionstrade', component: MarginOptionsTradeComponent },
      { path: 'marginoptionstradeRightPanel', component: RightPanelMarginOptionsComponent, outlet: 'right-panel' },
      { path: 'futurestrade', component: FuturesTradeComponent },
      { path: 'futurestradeRightPanel', component: RightPanelFuturesComponent, outlet: 'right-panel' },
      { path: 'lending-ob', component: LendingObComponent },
      { path: 'lendingObRightPanel', component: LendingRpComponent, outlet: 'right-panel' },
      { path: 'treasury', component: TreasuryComponent, canActivate: [treasuryAccessGuard] },
      { path: 'treasuryRightPanel', component: RightPanelTreasuryComponent, outlet: 'right-panel', canActivate: [treasuryAccessGuard] },
